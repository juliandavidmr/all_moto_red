/*
  ...
  - Made the column `motorcycleLinksId` on table `Motorcycle` required. This step will fail if there are existing NULL values in that column.
...
CREATE TABLE "new_Motorcycle" (
    ...
    "motorcycleLinksId" TEXT NOT NULL,
    ...
    FOREIGN KEY ("motorcycleLinksId") REFERENCES "MotorcycleLinks" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
